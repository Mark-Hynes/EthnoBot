$(document).ready(function(){
	...
	var iEditHTML = '<div class="iEdit-img-edit"><canvas class="iEdit-img-edit-can"></canvas><canvas class="iEdit-img-edit-process-can"></canvas><div class="iEdit-img-edit-select"></div><div class="iEdit-img-edit-act iEdit-img-edit-save"> Done </div><div class="iEdit-img-edit-act iEdit-img-edit-cancel"> Cancel </div></div>';
		...
		open: function(imgObj, square, callback, imageType, imageQuality){
			...
			$(img).on("load", function(){
				...
				if(img.width > img.height){
					...
					iEdit.selectionBox.height(200);
					iEdit.selectionBox.width(200);
